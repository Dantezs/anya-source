...
description: "sub",
  options: [
    {
      name: 'ver',
      description: 'Veja o seu perfil, ou o perfil de algum membro',
      description_localizations: {"en-US":"View your profile, or a member's profile"},
...
let list = [];
   ...
   // if (user.marry.has) list.push("CASADO");
    ...
    if (interaction.guild.ownerId === member.id) list.push("SERVER_OWNER");
				...
				new Discord.ButtonBuilder()
					.setCustomId("profile")
                              .setLabel("Alterar Sobre Mim")
                                ...
                                .setEmoji("<:emoji_91:1081004278094766170>")
                              .setDisabled(false),
                new Discord.ButtonBuilder()
					...
					.setCustomId("fundos")
                              ...
                              .setLabel("Alterar fundo")
                                ...
                                .setEmoji("<:d_rosinhabrava:1081005845036421190>")

                              .setDisabled(false),
			);

        interaction.editReply({ content: `Este é o perfil de ${member.tag}, algo mais?`, components: [row], files: [attachment], fetchReply: true})//.then(() => interaction.editReply({ content: `Este é o perfil de ${member.tag}, algo mais?`, components: [row], files: [attachment]}))
